...
For this activity, I wanted to visualize the table of numbers that Real Clear Politics presents its viewers and wireframed the following graph. <img src="https://i.postimg.cc/25mByM14/IMG-20190918-211131.jpg" width="600"><br>
...
To appease my critics and also the viewers of Real Clear Politics (which seems to cater toward a more "nerdy" statistician viewer), I decided to get rid of some of the childish elements like the confusing finish line. In the end I went with a box and whisker plot, which showcases range in a format that a viewer versed in basic statistics can immediately recognize for what it is. I thought that would suit the Real Clear Politics audience nicely. The graphs were made using Tableau and the source information from Real Clear Politics.<br>
<img src="https://i.postimg.cc/bNkJnLcL/poll.jpg" width="700">
...
(Note: The graph's averages don't precisely match those in the initial sample table because the data had been updated in the interim. I decided to capture the image before further iterations occurred.)

To improve upon these versions (but with more data outside this scope), I thought about creating a version with "weighted" poll results, whereby those who are more trustworthy might be indicated by circle size and also pull the average toward their outcomes. That seems like a subjective weight though, and I'm not sure if such a ranking has been carried out and quantified. Finally, the chart would have to be able to reflect actively changing data, perhaps keeping the rande of results at ~2weeks.
